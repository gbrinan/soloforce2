// MyMovie Mantine theme — 마이크루 디자인 시스템 통합 토큰 (jarvis 인디고)
// CSS variables in tokens.css drive the rest (canvas/card/text/border etc).
// Keep this module narrow: palette + primary color + radius/font defaults only.
...
export const mymovieTheme = createTheme({
  primaryColor: "jarvis",
